                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6 col-md-7 col-12">
                                <ul class="top-contact">
                                    <li><i class="fa fa-phone"></i>03245110039</li>
                                    <li><i class="fa fa-envelope"></i><Link to="mailto:support@yourmail.com">tazkiyahriphah56@gmail.com</Link></li>
                                </ul>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="inner">
                            <div class="row rowww">
                                <div class="col-lg-3 col-md-3 col-12 p-0 m-0">
                                    <div className="logo p-0 m-0 flex" style={{ display: 'flex', justifyContent: 'space-between', width: '100%', alignItems: 'center' }}>
