      ...
      <div className='main-login flex'>
        <div className="left-login">
          <div className="sign-in mt-10 px-10 ">
            <p className='signin dark:text-white text-center font-normal'>Login</p>
          </div>
          <form onSubmit={handleFormSubmit} className="below-name mt-5 ml-10">
            ...
            <div className="forgot">
              <p onClick={() => { setForgetPasswordPopup(true) }} className='mt-3 font-normal text-2xl dark:text-gray-300 cursor-pointer ease-in duration-300 forgetpass' >Forget Password</p>
            </div>
