...
const SelectedSemester = ({selectDpt, setSelectDpt, setSelectedSemester, selectedSemesterTemp, setSelectedSemesterTemp}) => {
    return (
        <div>
            <React.Fragment>
                <Dialog
                ...
                >
                    <DialogTitle id="alert-dialog-title">
                        <h1 style={{ fontSize: '20px', fontWeight: 'italic' }}>Select Semester</h1>
                        <hr style={{ margin: '10px 0 0 0' }} />
                    </DialogTitle>
                    <div style={{ margin: '0px 20px' }} >
                        <p style={{ fontSize: '14px', textAlign: 'justify', marginBottom: '20px' }}>Select acacemic semester to see the mentors list and assign mentees.</p>
