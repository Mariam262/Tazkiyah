                    ...
                    </DialogTitle>
                    {
                        changePassword ? (<>
                            <div style={{ margin: '0px 20px' }} >
                                ...
                                <input onChange={ImageUpload} style={{ fontSize: '15px', marginBottom: '20px', padding: '10px' }} className="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-pink-600 dark:placeholder-gray-400" id="file_input" type="file" accept='image/*' />
